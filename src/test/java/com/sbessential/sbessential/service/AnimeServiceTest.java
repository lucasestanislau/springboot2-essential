...
import com.sbessential.sbessential.util.AnimePutRequestBodyCreator;
...
class AnimeServiceTest {
    ...
    @Test
    @DisplayName("findByIdOrThrowBadRequestException throws BadException when anime is not found")
    void findByIdOrThrowBadRequestException_ThrowsBadRequestException_WhenAnimeIsNotFound(){
        ...
        Assertions.assertThatExceptionOfType(BadRequestException.class).isThrownBy(
                () -> animeServiceMock.findByIdOrThrowBadRequestException(1L));
    }
    ...
    void findByName_ReturnsListOfAnime_WhenSuccessful(){
        ...
        List<Anime> animes = animeServiceMock.findByName("anime qualquer");
